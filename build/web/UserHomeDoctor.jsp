                      ...
                      <div id="appointments">
                          ...
                          <%
                              ...
                              for(int i=0; i<Apps.size();i++){
                               out.print("<tr class=\"appointments\"><td>"+Apps.get(i).patient_firstname+" "+Apps.get(i).patient_lastname+"</td><td>"+Apps.get(i).patient_email+"</td><td>"+Apps.get(i).date+"</td><td>"+Apps.get(i).time+"</td><td>"+Apps.get(i).status+"</td><td><a href=\"SeePatient.jsp?id="+Apps.get(i).patient_id+"\">See Patient</a></td></tr>");
                              }
                          %>
                          </table>
                      </div>
                          ...
                          <%
                              ArrayList<Patient> App = LoadingInformation.loadPatients(userid);
                              for(int i=0; i<App.size();i++){
                               out.print("<tr class=\"patients\"><td>"+App.get(i).firstname+" "+App.get(i).lastname+"</td><td>"+App.get(i).email+"</td><td>"+App.get(i).symptoms+"</td><td>"+App.get(i).age+"</td><td>"+App.get(i).diagnosis+"</td><td>"+App.get(i).tests+"</td><td><a href=\"SeePatient.jsp?id="+App.get(i).patient_id+"\">See Patient</a></td></tr>");
                              }
                          %>
                          </table>
                      </div>
